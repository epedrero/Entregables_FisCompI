...
int main()
{
    ...
    // Se eliminan los datos que no se piden
    remove("error_euler_h1.dat");
    remove("error_euler_h2.dat");
    remove("error_rk4_h1.dat");
    remove("error_rk4_h2.dat");
    remove("error_rk45.dat");
    remove("posicion_analitica.dat");
